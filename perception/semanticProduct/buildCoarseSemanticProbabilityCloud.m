...
%       height in components for which heightAvailable is true
    ...
    if isfield(cfg,'frameCalibration'), probabilityCloud.frameCalibration=cfg.frameCalibration; end
    if isfield(cfg,'projectionTranslation'), probabilityCloud.projectionTranslation=cfg.projectionTranslation; end
