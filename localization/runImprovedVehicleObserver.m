...
function validateRuntimeConfig(cfg)
    ...
    assert(~any(isfield(cfg.measurement,{'gpsMaximumAge','lidarMaximumAge','minimumPoseInterval', ...
        'maximumPoseInterval','inputHistoryDuration','inputInterpolation'})), ...
        'VehicleLocalization:LegacyConfiguration','Remove the old event/pulse/hold configuration.');
end
