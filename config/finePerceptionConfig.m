...
% distance rejection about fitted lines or planes. No online dependency.
    cfg = struct("poleMinimumHeight", 1.0, "poleMaximumRadius", 0.35, ...
        ...
        "poleShortSupportHeight", 2.0, "poleShortSupportMaximumRadialRms", 0.10, ...
    ...
    cfg.curbCompetingEdgeDuplicateBandMeters = 0.25;
    cfg.curbCompetingEdgeRadiusMeters = 1.5;
    cfg.curbCompetingEdgeMinimumSeparationMeters = 0.4;
