function report = matchSavedPerception(observationPath,mapPath,outputDirectory,frameIndices,sourceConfig)
...
% No perception, map fitting, or registration parameter tuning is performed.
    if nargin<5, sourceConfig=coarseSemanticProbabilityCloudConfig(); end
    ...
    cfg=distributionRegistrationConfig(); pcfg=sourceConfig;
